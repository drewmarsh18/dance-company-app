  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.container}>
        <Text style={styles.heading}>Prep Master Portal</Text>
        <Text style={styles.sub}>Welcome{session?.user?.name ? `, ${session.user.name}` : ""}!</Text>
        <Text style={styles.sub}>Portal dashboard coming soon.</Text>
