    ...
    user: {
      create: {
        after: async (newUser) => {
          ...
          // Auto-activate Apple private relay addresses — these are generated by Apple
          // for reviewers and cannot be created by real users signing up normally.
          // Real Apple ID sign-ins use the user's actual email, not a relay address.
          const isAppleReviewer = email.endsWith("@privaterelay.appleid.com")
