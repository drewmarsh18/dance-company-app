// Official brand colors for each university in the CDP roster.
// bg: background hex, text: foreground color for legibility.
export type UniversityColor = { bg: string; text: string }
